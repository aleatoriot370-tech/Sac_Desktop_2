...
from core.database import listar_reprovados_patrimonio
from modules.base_popup_module import BasePopupModule
from modules.aprovacoes.analise_comercial_patrimonio import AnaliseComercialPatrimonio


class ReprovadosPatrimonio(BasePopupModule):
    """Módulo 1.2.3.2 - Reprovados Patrimônio: OS Tipo P, Status 'Reprovado - Patrimônio'."""

    def __init__(self, usuario_logado: dict, parent=None):
        super().__init__(usuario_logado, parent)
        self.setWindowTitle("Comercial - Reprovados Patrimônio")
        self.resize(760, 500)
    ...
    def _montar_ui(self):
        ...
        titulo = QLabel("Reprovados Patrimônio")
    ...
    def _carregar(self):
        try:
            self._resultados = listar_reprovados_patrimonio()
    ...
    def _abrir_analise(self, linha: int, _coluna: int):
        ...
        dialogo = AnaliseComercialPatrimonio(self.usuario_logado, os_id, parent=self)
        dialogo.exec()
        self._carregar()
